...
export const DragAndDrop = <C extends Item, R extends Item>({
  type,
  props
    ...
    return (
      <Styled.Container>
        {props.columns.map((column, index) => {
          return <Column key={index} index={index} column={column} type='many' {...props} />;
        })}
      </Styled.Container>
    );
  }
...
export const Row = <R extends Item>({
  row,
  onDragStart,
  dataBefore,
  dataColumn,
