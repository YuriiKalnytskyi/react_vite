...
export const SettingsBork = ({
  ...
  const settingsOptions = [{ text: t('columns'), component: 'columns' }];
    ...
    columns: (
      <TagCommon gap={SPACES.xxs}>
        ...
        <TagCommon fd='row' jc='space-between'>
          <TextCommon width='fit-content' onClick={() => columns.setColumns([])}>
            {t('hide')}
          </TextCommon>
          <TextCommon width='fit-content' onClick={() => columns.setColumns(columns.default)}>
            {t('show')}
          </TextCommon>
        </TagCommon>
      </TagCommon>
            ...
            <AnimatePresence mode='wait'>
              {!component && (
                ...
                >
                  {settingsOptions.map((v) => (
                    <div key={v.text} className='option' onClick={onSetComponent.bind(this, v)}>
                      {v.text}
                    </div>
                  ))}
                </motion.div>
              ...
              {!!component && (
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <div className='back' onClick={onSetComponent.bind(this, null)}>
                    ← {t('back')}
                  </div>
